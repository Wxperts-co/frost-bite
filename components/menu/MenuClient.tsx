...
const MenuClient: React.FC<MenuClientProps> = ({ categories, menuData }) => {
  ...
  const items = currentCategory ? menuData[currentCategory.id] || [] : [];

  return (
    <>
      {/* Category Tabs - With Emojis (Client Side Tabs) */}
      <div className="relative md:sticky md:top-[80px] z-20 pt-[10px] pb-4 bg-transparent mb-8">
        ...
        {currentCategory && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">{currentCategory.desc}</p>
                  ...
                  <div className="flex flex-row gap-4 p-4 h-full">
                    ...
                    <div className="flex-1 flex flex-col justify-between min-w-0">
                      ...
                      <div className="mt-3 flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-gray-100">
                        ...
                        <button
                          onClick={(e) => handleAddClick(item, currentCategory.emoji, e)}
