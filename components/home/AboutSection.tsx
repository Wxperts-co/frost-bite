...
import { 
  FaStar, FaPhone, FaMapMarkerAlt, FaClock, FaIceCream, 
  FaTruck, FaStore, FaCookieBite, FaLeaf, FaIceCream as FaIceCreamCone
} from 'react-icons/fa';
...
const AboutSection = () => {
  ...
  const signatureFlavors = [
    { name: "Hot Fudge Sundae", icon: GiChocolateBar, desc: "Rich, indulgent treat with warm, gooey fudge", color: "#6B3E26" },
    { name: "Cookie Dough Sundae", icon: FaCookieBite, desc: "Smooth vanilla ice cream with raw cookie dough chunks", color: "#D4A373" },
    { name: "Mint Chocolate Chip", icon: FaLeaf, desc: "Refreshing mint with rich chocolate chips", color: "#2E8B57" },
    { name: "Strawberry Sundae", icon: GiStrawberry, desc: "Fresh, fruity goodness on velvety ice cream", color: "#FF6B6B" },
  ];
        ...
        <p className="text-[18px] font-semibold text-gray-800">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold text-[#c07f07] tracking-wide">WELCOME TO FROST BITE</span>
            </motion.div>
            ...
            >
              ...
              <span className="block text-[#c07f07]">the consistency you want—</span>
            ...
            >
              <p className="text-gray-600 leading-relaxed">
                If you're in the mood for a treat that'll satisfy your sweet tooth, <span className="font-semibold text-[#046069]">Frost Bite in Avon, Indiana</span>, 
                is a must-visit destination! Located at <span className="font-semibold">7025 Galen Dr W</span>, Frost Bite is the perfect spot 
                to enjoy a variety of delicious frozen delights. Whether you're craving something classic or adventurous, 
                this cozy ice cream shop has something for everyone.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Frost Bite has a laid-back vibe, making it an ideal spot for families, friends, or anyone looking for a little indulgence. 
                It's easy to see why this place is a go-to for ice cream lovers in the area. Whether you're stopping by for a quick treat 
                or spending some time enjoying the flavors, you'll always find something to satisfy your cravings at Frost Bite.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {signatureFlavors.map((flavor, index) => (
                  ...
                  >
                    <flavor.icon style={{ color: flavor.color }} size={24} className="mt-1" />
                    <div>
                      <div className="font-semibold text-gray-800">{flavor.name}</div>
